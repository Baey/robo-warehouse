...
class FanController(Node):
    ...
    ros2 run ros_gz_bridge parameter_bridge /model/Depot/joint/fan1_joint/cmd_vel@geometry_msgs/msg/Twist@gz.msgs.Twist
    """
    ...
    def __init__(self):
        ...
        Creates a publisher for Twist messages on the '/model/Depot/joint/fan1_joint/cmd_vel' topic
        and sets up a timer to call the timer_callback method at regular intervals.
        """
        super().__init__('tugbot_diff_drive_controller')
        self.publisher_ = self.create_publisher(Twist, '/model/Depot/joint/fan1_joint/cmd_vel', 10)
        timer_period = 0.1
    ...
    def timer_callback(self):
        ...
        a fixed linear and angular velocity to the '/model/Depot/joint/fan1_joint/cmd_vel' topic.
        """
        msg = Twist()
        msg.linear.x = 0.0
        msg.linear.y = 0.0
